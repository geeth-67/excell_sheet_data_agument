...
public class LoginTestIncorrectBoth extends BaseTest {
    ...
    public void testLoginUsingExcelData() {
        ...
        String username = ExcelUtil.getCellData("Sheet1", 10, 0);
        String password = ExcelUtil.getCellData("Sheet1", 10, 1);
